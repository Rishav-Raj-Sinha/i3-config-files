import"../../modulepreload-polyfill.js";import{c as $,a as tt,b as et,r as h,d as e,l as p,e as nt,f as B,g as I,j as t,t as a,s as N,h as U,i as S,k as it,m as st,M as v,u as ot,n as L,o as at,p as ct,q as rt,v as lt,w as dt}from"../../arrow-down.js";var G=$("popup"),P=tt("popup",n=>G.postMessage(n));G.onMessage(P.handleMessage);var{sendMessage:y,onMessage:pt}=P;et(P);function _(n,s){const[i,o]=h.useState(n);return h.useEffect(()=>{s(o)},[]),[i,o]}const gt=e(B.div)`
  position: fixed;
  inset: 0;
