"use strict";
(() => {
  // src/connectors/openfm.ts
  Connector.playerSelector = "#player-controlbar";
  Connector.isPodcast = () => Util.hasElementClass(Connector.playerSelector, "podcast");
  ...
  Connector.pauseButtonSelector = [
    `${Connector.playerSelector} button[name="play"][style*="e822"]`,
    // stop button
    `${Connector.playerSelector} button[name="play"][style*="e813"]`
    // pause button
  ];
})();
