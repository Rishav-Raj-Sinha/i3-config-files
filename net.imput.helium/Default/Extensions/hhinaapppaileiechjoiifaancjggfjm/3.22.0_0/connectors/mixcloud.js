...
(() => {
  ...
  var playerSelector = "[data-testid=player-container]";
  var artistSelector = "[class*=styles__Artist-]";
  var trackSelector = "[class*=styles__Track-]";
  ...
  Connector.isPodcast = () => Boolean(!Util.isElementVisible([artistSelector, trackSelector]));
