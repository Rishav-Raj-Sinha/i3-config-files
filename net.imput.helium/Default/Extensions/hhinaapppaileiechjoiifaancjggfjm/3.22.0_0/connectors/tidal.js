...
(() => {
  ...
  var artistSelector = `${Connector.playerSelector} a[data-test="grid-item-detail-text-title-artist"]`;
  Connector.getArtist = () => {
  ...
  Connector.getAlbumArtist = () => {
    ...
    if ("album" === albumUrlSegments?.at(-2) && "album" === pageUrlSegments?.at(-2) && albumUrlSegments?.at(-1) === pageUrlSegments?.at(-1)) {
