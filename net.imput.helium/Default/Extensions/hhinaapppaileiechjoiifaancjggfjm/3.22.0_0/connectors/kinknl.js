...
(() => {
  ...
  var playPauseButtonSelector = `${Connector.playerSelector}>button>svg`;
  Connector.isPlaying = () => {
  ...
  Connector.scrobblingDisallowedReason = () => Connector.getArtist()?.startsWith("KINK") ? "FilteredTag" : null;
