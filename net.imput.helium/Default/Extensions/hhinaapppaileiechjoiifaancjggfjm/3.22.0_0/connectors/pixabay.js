...
(() => {
  ...
  Connector.currentTimeSelector = "[class*=progress] [class*=timing--]:first-child";
  ...
  Connector.unloveButtonSelector = '[class*=playbar--] button [aria-label="HeartFilled"]';
})();
